...
const listaProdutos = produtos.map((novoArray) => {// map criar um nvo array
    return {// colocar a {} para retornar um novo array
       id: novoArray.id,
       nome: novoArray.nome,
       preco: novoArray.precoUnitario * 1.15 //pegando o novoArray e inserindo no preço o acrescimo de 1,15%
    }
